# This is a tenmporary modified version based on:
# https://src.fedoraproject.org/rpms/python-suds/tree/
...
# original code does not work with python3.
%bcond_with python3
%bcond_without test
...
%else
%global py2_deps python-devel python-six
%endif
%endif
...
# 1. hg clone https://bitbucket.org/jurko/suds
# 2. (cd suds; tar --bzip2 -cvf ../$(c=94664ddd46a61d06862fa8fb6ba7b9e054214f57; echo ${c:0:12}).tar.bz2 .)
...
mkdir %{py3_builddir}
cp -a ./* %{py3_builddir}/ || :
(cd %{py3_builddir} && %py3_build)
%endif

%install
%py2_install
%if %{with python3}
(cd %{py3_builddir} && %py3_install)
%endif
...
%if %{with python3}
(cd %{py3_builddir} && %{__python3} setup.py test)
%endif
%endif
...
%changelog
* Thu Aug 16 2018 Satoru SATOH <ssato@redhat.com> - 0.7-0.10.94664ddd46a6
